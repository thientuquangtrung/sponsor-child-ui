    ...
    const steps = [
        {
            ...
            title: 'Tạo tài khoản',
            description:
                'Tạo tài khoản để bắt đầu sử dụng các tính năng gây quỹ minh bạch và đăng ký trở thành Người Bảo Lãnh cho chiến dịch.',
        },
        {
    ...
    return (
        <div className="container mx-auto px-4 py-12 font-sans">
                ...
                {steps.map((step, index) => (
                    <Card key={index} className="flex flex-col">
                        <CardHeader className="flex flex-col items-center">
                            <div className="rounded-full bg-secondary text-white p-3 mb-4">{step.icon}</div>
            ...
            <div className="mt-12 text-center">
                <Button
                    size="lg"
                    className="bg-gradient-to-l from-teal-200 to-rose-200"

...
// import React, { useState } from 'react';
// import { useParams } from 'react-router-dom'; // Import useParams to get the campaignID
// import { useSelector } from 'react-redux';
// import { useForm } from 'react-hook-form';
// import { cn } from '@/lib/utils';
// import qrcode from '@/assets/images/qrcode.jpg';
...
// import { Dialog, DialogContent, DialogDescription, DialogTitle } from '@/components/ui/dialog';
// import { Form, FormControl, FormField, FormItem, FormLabel, FormMessage } from '@/components/ui/form';
// import { useGetCampaignByIdQuery } from '@/redux/campaign/campaignApi'; // Import API
// import { useCreateDonationMutation } from '@/redux/donation/donationApi';
...
//     const [createDonation, { isLoading: isCreatingDonation }] = useCreateDonationMutation(); // API for creating donation
...
//         const donationData = {
//             donorID: '04543f23-4636-4f0a-8945-eb5fdc71f738', //user?.id // Current user ID
//             campaignID: id, // Campaign ID from the URL
//             amount: amountValue, // Donation amount
//             isAnonymous: data.anonymous, // Anonymous flag
//             cancelUrl: 'https://example.com/cancel', // Hardcoded cancel URL
//             returnUrl: 'https://example.com/success', // Hardcoded return URL
//         };
...
//                         <img
//                             className="w-12 h-12 rounded-full border-[#69A6B8] border-[3px]"
//                             src={campaign?.guaranteeAvatar || 'https://via.placeholder.com/100'} // Display guarantee avatar
//                             alt="Profile"
//                         />
//                         <div>
//                             <span className="text-gray-500">Tiền ủng hộ được chuyển đến</span>
//                             <div className="flex items-center">
//                                 <h1 className="text-lg font-bold text-[#69A6B8] truncate max-w-xs mr-2">
//                                     {campaign?.guaranteeName || 'Quỹ thiện nguyện'} {/* Display guarantee name */}
//                                 </h1>
//                                 <div className="bg-[#69A6B8] p-1 rounded-full">
//                                     <Check className="text-white" size={10} />
//                                 </div>
...
//                                     {campaign?.raisedAmount?.toLocaleString('vi-VN') || '0'} VND
//                                 </span>
//                             </p>
//                             <p className="font-bold text-lg">{Math.round((campaign?.raisedAmount / campaign?.targetAmount) * 100) || 0}%</p>
//                         </div>
//                         <div className="h-2 w-full bg-gray-300 rounded">
//                             <div
//                                 className="h-2 bg-green-500 rounded"
//                                 style={{
//                                     width: `${Math.round((campaign?.raisedAmount / campaign?.targetAmount) * 100) || 0}%`,
//                                     background: 'linear-gradient(to right, #7EDAD7, #69A6B8)',
//                                 }}
//                             ></div>
//                         </div>
//                         <div className="flex items-center justify-between text-sm text-black mt-2">
//                             <p className="text-gray-500 font font-semibold">
//                                 Của mục tiêu <span className="font-bold text-black ">{campaign?.targetAmount?.toLocaleString('vi-VN') || '0'} VND</span>
//                             </p>
//                             <p className="font-bold">
...
//                                 <div className="flex mb-2">
//                                     <span className="w-[39%] text-gray-600">Số tiền:</span>
//                                     <span className="font-semibold text-teal-500">{amount} VND</span>
//                                 </div>
//                                 <div className="flex items-center">
//                                     <span className="w-[39%] text-gray-600">Nội dung chuyển khoản:</span>
//                                     <span id="copyContent" className="font-semibold text-black">
